...
class CoreBankingUI:
    ...
    def CB_Menu(self):
        while True:
            ...
            print("6. Ambil Antrian")
            print("7. Panggil Antrian")
            print("8. Statistik Antrian")
            print("X. Exit")
            choose=input("\n\nMasukan pilihan:")
            if choose=="1":
                self.CB_NewAccount()
                ...
                self.CB_AmbilAntrian()
            elif choose=="7":
                self.CB_PanggilAntrian()                
            elif choose=="8":
                self.CB_StatistikAntrian()                
            elif choose.upper()=="X":
                break
    ...
    def CB_AmbilAntrian(self):
        noAntrian=self.QAntrian.enQueue()
        print("\n\nNomor Antrian:", noAntrian, "\n\n")
        
    def CB_PanggilAntrian(self):
        noCounter=input("No.Counter:")
        noAntrian=self.QAntrian.deQueue()
        print("\n\nNomor Antrian:", noAntrian, "menuju ke Counter:",noCounter,"\n\n")
        
    def CB_StatistikAntrian(self):
        print("\n\nStatistik Antrian:\n\n")
        self.QAntrian.statistic()
        print("\n\n")
